const ru = {
    ...
    programmingSection: {
        ...
        start: 'Разработкой программного обеспечения занимаюсь на протяжении уже практически пяти лет. За это время успел познакомиться и использовать следующие технологии:',

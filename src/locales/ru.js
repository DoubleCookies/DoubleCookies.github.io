const ru = {
    mainPage: {
        ...
        intro: 'Привет! Меня зовут Игорь, а для некоторых я известен как DoubleCookies — тот, кто любит программировать, кушать печенье, изучать статистику и не только!',
    },
    aboutThisPage: {

const ru = {
    mainPage: {
        ...
        intro: 'Привет! Меня зовут <1>Игорь</1>, а для некоторых я известен как <1>DoubleCookies</1> — тот, кто любит программировать, кушать печенье, изучать статистику и не только!',
    },
    aboutBlock: {

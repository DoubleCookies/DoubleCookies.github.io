export const ru = {
    wikiWamLog: {
        ...
        wamIntroFinish:
            'С помощью специальных скриптов я сохранил у себя значения рейтинга ' +
    ...
    stringSwap: {
        ...
        fileNamesInfo:
            'Модуль для страницы неиспользуемых файлов. Позволяет вытащить нужные названия файлов, ' +
        ...
        galleryGeneratorInfo:
            'Модуль для генерации списка файлов с нужным номером. Использовался раньше для ' +
    ...
    stats4wiki: {
        ...
        aboutText:
            'В нём собираются данные по топ-50 самых скачиваемых и залайканных уровней в Geometry Dash ' +
        ...
        workList:
            'Всё довольно просто и последовательно:<1>' +
        ...
        plansList:
            '<0><1>Можно будет пройтись по старым коммитам, собрать информацию по прошлым месяцам/годам ' +
    ...
    gdStatistics: {
        ...
        aboutText:
            'Этот проект посвящён сбору статистики по уровням в Geometry Dash — сколько раз ' +

export const en = {
    wikiWamLog: {
        wamIntroStart:
            'WAM (Wiki Activity Monitor) — rating of the largest wikis on FANDOM. ' +
    ...
    stringSwap: {
        ...
        fileNamesInfo:
            'Module for unused files page. Allow to get correct filenames which are difficult to get otherwise.',
        ...
        galleryGeneratorInfo:
            'Module for generating file names with numbers. Used for galleries, now it lost relevance ' +
    ...
    stats4wiki: {
        ...
        aboutText:
            'I collect data about top-50 most downloaded and most liked levels in Geometry Dash ' +
        ...
        workList:
            'Everything is pretty simple and consecutive:<1>' +
        ...
        plansList:
            '<0><1>I can check old commits, collect data from old months/years and ' +
    ...
    gdStatistics: {
        ...
        aboutText:
            'This project is about collecting data about levels in Geometry Dash — how many times level was downloaded, liked, ' +

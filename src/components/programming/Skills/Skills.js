                    ...
                    <Tabs defaultActiveKey="1" type="card">
                        <TabPane tab={t('backendTab')} key="1">
                            ...
                            <Trans i18nKey="programmingSection:backendSkills">
                                <ul style={{ marginTop: 10 }}>
                                    ...
                                    <li>
                                        Hibernate and PostgreSQL for databases. Also worked with MS SQL Server and
                                        Oracle Database.
                                    </li>
                                </ul>
                            </Trans>
                        ...
                        <TabPane tab={t('frontendTab')} key="2">
                            ...
                            <Trans i18nKey="programmingSection:frontendSkills">
                                <ul style={{ marginTop: 10 }}>
                                    <li>
                                        JavaScript and TypeScript as programming language. I don't know what is better.
                                    </li>
                                    <li>
                                        React. Tried Angular before but it isn't my cup of tea. Maybe I'll try Vue and
                        ...
                        <TabPane tab={t('otherTab')} key="3">
                            ...
                            <Trans i18nKey="programmingSection:otherSkills">
                                <ul style={{ marginTop: 10 }}>
                                    ...
                                    <li>
                                        Github Pages + Jekyll. Hosting pages for free is awesome, and powerful static
                                        pages generator is good addition to it!
                                    </li>
                                </ul>
                            </Trans>
                        </TabPane>
